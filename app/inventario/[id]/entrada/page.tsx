...
export default function EntradaInventarioPage({ params }: { params: { id: string } }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: `Se ha registrado la entrada de ${quantity} ${material.unit} de ${material.name}`,
      })
    ...
    <RoleGuard allowedRoles={["admin", "asistente"]}>
      <div className="flex flex-col p-6 space-y-6">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-2xl font-bold">Registrar Entrada de Material</h1>
        </div>
        ...
        <Card>
          <form onSubmit={handleSubmit}>
            <CardHeader>
              ...
              <CardDescription>
                Registrar entrada de {material.name} ({material.unit})
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="quantity">Cantidad a ingresar ({material.unit})</Label>
                <Input
                  id="quantity"
                  type="number"
                  min="0.01"
